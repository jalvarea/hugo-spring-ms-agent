package com.ejemplo.product.infrastructure.input.rest.error;
...
import com.test.services.server.models.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDuplicateIdentification(DuplicateIdentificationException ex, HttpServletRequest request) {
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(OffsetDateTime.now())
